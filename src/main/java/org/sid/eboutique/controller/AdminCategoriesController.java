...
public class AdminCategoriesController implements HandlerExceptionResolver {
	...
	public String saveCat(@Valid Categorie c, Model model, BindingResult bindingResult, MultipartFile file)
			throws IOException {
...
//			if (model.asMap().get("editedCat") != null) {
	...
	public String supprimer(Model model,Long idCat) {
	...
	public String modifier(Model model,Long idCat) {
		Categorie c=metier.getCategorie(idCat);
